from beacon.connections.mongo.__init__ import tumors

endpoint_name="tumors"
...
disease_lookup=True # True if your beacon enables endpoint analyses/{id}/datasets