from beacon.connections.mongo.__init__ import patients

endpoint_name="patients"
...
disease_lookup=True # True if your beacon enables endpoint analyses/{id}/cohorts
