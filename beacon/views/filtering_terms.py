...
class FilteringTermsView(EndpointView):
    ...
    async def handler(self):
        ...
        # Catch the cases where the Filtering Terms response is not valid against the reference schema
        ...
        # Give a HTTP response with json data application and a 200 status, and the Filtering Terms object class collected
