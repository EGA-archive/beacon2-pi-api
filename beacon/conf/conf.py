...
level=logging.DEBUG
log_file=None
beacon_id = 'org.ega-archive.beacon-elixir-demo'  # ID of the Beacon
beacon_name = 'Beacon Production Implementation ELIXIR demo'  # Name of the Beacon service
api_version = 'v2.2.0' # Version of the Beacon implementation
uri = 'https://beacon-elixir-demo.ega-archive.org'
uri_subpath = '/api'
