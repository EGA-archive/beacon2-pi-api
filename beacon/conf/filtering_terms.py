...
alphanumeric_terms = alphanumeric_terms_cohorts + alphanumeric_terms_biosamples + alphanumeric_terms_datasets + alphanumeric_terms_g_variants + alphanumeric_terms_individuals + alphanumeric_terms_runs + alphanumeric_terms_patients + alphanumeric_terms_analyses